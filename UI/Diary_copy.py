...
class Ui_Diary(object):
    def setupUi(self, Diary):
        ...
        self.centralwidget = QtGui.QWidget(Diary)
        self.centralwidget.setObjectName(_fromUtf8("centralwidget"))
        self.comboShoe = QtGui.QComboBox(self.centralwidget)
        self.comboShoe.setGeometry(QtCore.QRect(70, 200, 69, 22))
        self.comboShoe.setObjectName(_fromUtf8("comboShoe"))
        self.lineDistance = QtGui.QLineEdit(self.centralwidget)
        ...
        self.comboRunType = QtGui.QComboBox(self.centralwidget)
        self.comboRunType.setGeometry(QtCore.QRect(70, 160, 69, 22))
        self.comboRunType.setObjectName(_fromUtf8("comboRunType"))
        self.lineSpeed = QtGui.QLineEdit(self.centralwidget)
        self.lineSpeed.setGeometry(QtCore.QRect(80, 290, 113, 20))
        self.lineSpeed.setObjectName(_fromUtf8("lineSpeed"))
        self.comboDistance = QtGui.QComboBox(self.centralwidget)
        ...
        self.comboDistance.addItem(_fromUtf8(""))
        self.linePace = QtGui.QLineEdit(self.centralwidget)
        self.linePace.setGeometry(QtCore.QRect(80, 330, 113, 20))
        self.linePace.setObjectName(_fromUtf8("linePace"))
        self.comboSpeed = QtGui.QComboBox(self.centralwidget)
        ...
        self.comboSpeed.addItem(_fromUtf8(""))
        self.comboPace = QtGui.QComboBox(self.centralwidget)
        ...
        self.lineWeight = QtGui.QLineEdit(self.centralwidget)
        self.lineWeight.setGeometry(QtCore.QRect(80, 520, 61, 20))
        self.lineWeight.setObjectName(_fromUtf8("lineWeight"))
        self.lineRestingHR = QtGui.QLineEdit(self.centralwidget)
        ...
        self.timeDiary = QtGui.QTimeEdit(self.centralwidget)
        ...
        self.DateDiary = QtGui.QDateEdit(self.centralwidget)
        ...
        self.lineStravaID = QtGui.QLineEdit(self.centralwidget)
...
"}"))
        ...
        self.menubar = QtGui.QMenuBar(Diary)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 800, 21))
        self.menubar.setObjectName(_fromUtf8("menubar"))
        Diary.setMenuBar(self.menubar)
        self.statusbar = QtGui.QStatusBar(Diary)
